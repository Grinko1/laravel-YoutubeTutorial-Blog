...
<main class="blog-post">
        <div class="container">
            ...
            <section class="blog-post-featured-img" data-aos="fade-up" data-aos-delay="300">
                <img src="{{asset('storage/' . $post->main_image)}}" alt="featured image" class="w-100 h-50">
            </section>
                    ...
                    <section class="comment-section">
                        ...
                        <form action="{{route('post.comment.store', $post->id)}}" method="post">
                            ...
                            <div class="row">
                                ...
                                <textarea name="message" id="comment" class="form-control" placeholder="" rows="10"></textarea>
                                </div>
